                ...
                children:[
                  ...
                  Visibility(visible: kategori,
                    child: Column(
                      children: [
                        ExpansionTile(
                          maintainState: kategoriSelected,
                          trailing: kategoriSelected ? const Icon(Icons.arrow_drop_up_sharp) : const Icon(Icons.arrow_drop_down_sharp),
                            ...
                            ExpansionTile(
                              ...
                              children: [
                                ListTile(
                                  ...
                                  trailing: selectedTile ? const Icon(Icons.check_outlined,color: Colors.white) : null,
                                ),
                                ListTile(
                                  textColor: Colors.white,
                                ...
                                ExpansionTile(trailing: const SizedBox(),
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      trailing: selectedTile ? const Icon(Icons.check_outlined,color: Color.fromRGBO(6, 96, 158, 1)) : null,
                                    ),
                                    ListTile(
                        ...
                        Visibility(visible: kategori,
                          child: ExpansionTile(
                            ...
                            collapsedTextColor: const Color.fromRGBO(6, 96, 158, 1),
                            collapsedBackgroundColor: Colors.white,
                            title: const Text("Durchmesser",style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),),
                            children:  [
                              ListTile(
                                title: const Text("14.00 mm (25)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                        ...
                        Visibility(visible: kategori,
                          child: ExpansionTile(
                            ...
                            collapsedTextColor: const Color.fromRGBO(6, 96, 158, 1),
                            collapsedBackgroundColor: Colors.white,
                            title: const Text("Stärke",style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),),
                            children:  [
                              ListTile(
                                  title: const Text("Ohne Stärke",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("-0.75 (9)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("-1.00 (23)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("-1.25 (8)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("-1.50 (19)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("-1.75 (9)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                title: const Text("-2.00 (9)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                        ...
                        Visibility(visible: kategori,
                          child: ExpansionTile(
                            ...
                            collapsedTextColor: const Color.fromRGBO(6, 96, 158, 1),
                            collapsedBackgroundColor: Colors.white,
                            title: const Text("Serie",style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),),
                            children:  [
                              ListTile(
                                  title: const Text("Jasmine (4)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("Mirel (8)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("Rose (4)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                        ...
                        Visibility(visible: kategori,
                          child: ExpansionTile(
                            ...
                            collapsedTextColor: const Color.fromRGBO(6, 96, 158, 1),
                            collapsedBackgroundColor: Colors.white,
                            title: const Text("Jahr",style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),),
                            children:  [
                              ListTile(
                                  title: const Text("Kontaktlinsen 2020 (1)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                setState(() {
                                  selectedTile = !selectedTile;
                                });
                              ...
                              ListTile(
                                  title: const Text("Kontaktlinsen 2018 (17)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
                              ...
                              ListTile(
                                  title: const Text("Kontaktlinsen 2017 und früher (3)",style: TextStyle(fontSize: 11),),
                                onTap: () {
                                  setState(() {
                                    selectedTile = !selectedTile;
                                  });
